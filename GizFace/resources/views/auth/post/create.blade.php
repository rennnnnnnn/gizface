    ...
    <div class="row" style="margin-left: 160px;margin-top:40px; width:70%;">
        <form name="f1" id="form1" action="" target="_self" class="post-form" method="get" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="image-field-wrapper">
                    <div class="thumb-wrapper">
                        <img class="media-object" id="image" src="">
                    </div>
            ...
            <div class="form-group" id="mdrender">
                ...
                @endif
                <div id="mdraw">
                    <textarea class="form-control row-10" rows="10" name="body" id="markdown_editor_textarea" placeholder="markdownに対応しています"></textarea>
                </div>
...
$(function(){
    ...
    $('#register').on('click',function(){
        $('#form1').attr("action","{{ route('post.save') }}");
